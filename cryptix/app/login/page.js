        ...
        <div className="bg-black/50 backdrop-blur-md rounded-lg p-8 border border-white/20"></div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 bg-black/50 border border-white/30 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-white hover:bg-gray-200 disabled:bg-gray-400 text-black py-2 px-4 rounded-md font-medium transition-colors duration-200"
            >
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full bg-gray-800 hover:bg-gray-700 text-white py-2 px-4 rounded-md font-medium transition-colors duration-200 flex items-center justify-center border border-white/20"
            >
